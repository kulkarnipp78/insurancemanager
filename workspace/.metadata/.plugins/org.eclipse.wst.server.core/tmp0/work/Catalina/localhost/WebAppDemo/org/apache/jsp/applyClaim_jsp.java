 ...
 * Generated at: 2024-02-08 14:45:45 UTC
...
public final class applyClaim_jsp extends org.apache.jasper.runtime.HttpJspBase
...
if(request.getSession(false).getAttribute("type")==null)
{
      ...
      out.write("<title>Apply Claim</title>\n");
...
if(request.getSession(false).getAttribute("type").toString().equalsIgnoreCase("Insurance officer")){ 
 ...
 if(request.getSession(false).getAttribute("type").toString().equalsIgnoreCase("FIELD OFFICER") || request.getSession(false).getAttribute("type").toString().equalsIgnoreCase("Insurance officer"))
      ...
      out.write("<br>\n");
      out.write("<form action=\"ClaimController\" method=\"post\" name=\"claimform\" class=\"basic-grey\" onsubmit=\"return mandatory()\">\n");
      out.write("    <h1> \n");
      out.write("        Apply Claim\n");
      out.write("    </h1> <input type=\"hidden\" name=\"action\" value=\"addClaim\" />\n");
      out.write("     <label>\n");
      out.write("        <span>Policy Reference No :<sup><font color=\"red\">*</font></sup></span>\n");
      out.write("        <input type=\"text\" name=\"prefno\"  onblur=\"policyN(this.value)\"/><p id=\"policy_msg\">");
if(request.getAttribute("pref")!=null && request.getAttribute("pref").toString().equals("pref")){out.print("Policy reference number must be in NUMBER only and not empty."); } 
      out.write("</p>\n");
      out.write("    </label>\n");
      out.write("    <label>\n");
      out.write("        <span>Claim Amount :<sup><font color=\"red\">*</font></sup></span>\n");
      out.write("        <input type=\"text\" name=\"camount\" onblur=\"claimA(this.value)\"/><p id=\"claimAmu_msg\">");
if(request.getAttribute("camount")!=null && request.getAttribute("camount").toString().equals("camount")){out.print("Amount must be in NUMBER onlyand not empty."); } 
      out.write("</p>\n");
      out.write("    </label>\n");
      out.write("    <label>\n");
      out.write("        <span>Beneficiary Name :<sup><font color=\"red\">*</font></sup></span>\n");
      out.write("        <input type=\"text\" name=\"bname\" onblur=\"bName(this.value)\"/><p id=\"bname_msg\">");
if(request.getAttribute("bname")!=null && request.getAttribute("bname").toString().equals("bname")){out.print("Benificiery name is not empty and Character only."); } 
      out.write("</p>\n");
      out.write("    </label>\n");
      out.write("     <label>\n");
      out.write("        <span>Beneficiary Address :<sup><font color=\"red\">*</font></sup></span>\n");
      out.write("        <textarea name=\"baddress\" onblur=\"bAddress(this.value)\"></textarea><p id=\"baddress_msg\">");
if(request.getAttribute("baddress")!=null && request.getAttribute("baddress").toString().equals("baddress")){out.print("Benificiery Address must not empty."); } 
      out.write("</p>\n");
      out.write("    </label>\n");
      out.write("    <label>\n");
      out.write("        <span>Beneficiary Email Id :<sup><font color=\"red\">*</font></sup></span>\n");
      out.write("        <input type=\"text\" name=\"bemail\" onblur=\"bEmail(this.value)\"/><p id=\"bemail_msg\"></p>\n");
      out.write("    </label>\n");
      out.write("    <label>\n");
      out.write("        <span>Beneficiary Contact No. :<sup><font color=\"red\">*</font></sup></span>\n");
      out.write("        <input type=\"text\" name=\"bcontact\" onblur=\"bCon(this.value)\"/><p id=\"bcon_msg\">");
if(request.getAttribute("bcontact")!=null && request.getAttribute("bcontact").toString().equals("bcontact")){out.print("Contact must be only 10 digit and not empty."); } 
      out.write("</p>\n");
      out.write("    </label> \n");
      out.write("   \n");
      out.write("    <br>\n");
